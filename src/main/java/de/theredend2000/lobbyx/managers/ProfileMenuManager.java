...
public class ProfileMenuManager implements Listener {
    ...
    public  void createClanGuiLeader(Player player){
        ...
        for(String clanName : plugin.yaml.getConfigurationSection("Clans."+player.getUniqueId()+".").getKeys(false)) {
            ...
            Clan.setItem(38, new ItemBuilder(Material.PLAYER_HEAD).setDisplayname("§fAdvancements").setSkullOwner(Main.getTexture("ZTM0YTU5MmE3OTM5N2E4ZGYzOTk3YzQzMDkxNjk0ZmMyZmI3NmM4ODNhNzZjY2U4OWYwMjI3ZTVjOWYxZGZlIn19fQ==")).setLocalizedName("ClanMenu.Leader.Achivements").build());//wichtig der quark muss rein
