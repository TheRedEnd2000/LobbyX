...
public class ProfileMenuManager implements Listener {
    ...
    public void createLanguageInventory(Player player){
        ...
        Language.setItem(11, new ItemBuilder(Material.PAPER).setDisplayname("§4English").setLocalizedName("Settings.Language.Englisch").build());
        ...
        Language.setItem(18, new ItemBuilder(Material.ARROW).setDisplayname("§7Back").setLocalizedName("Settings.Language.Back").build());
