...
public class ProfileMenuManager implements Listener {
    ...
    public void createProfileInventory(Player player){
        ...
        int[] blueglass = new int[]{1,2,3,4,5,6,7,9,11,12,13,14,14,17,18,21,23,26,27,20,31,32,35,36,39,40,41,44,46,47,48,49,50,51,52};
        int [] anderesglass = new int[]{0,8,10,16,19,20,24,25,28,34,37,38,42,43,45};
