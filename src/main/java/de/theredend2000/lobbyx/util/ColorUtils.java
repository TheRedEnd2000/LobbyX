...
public class ColorUtils {
    ...
    private static HashMap<String, String> hexToMCColors = new HashMap<String, String>(); // HEX, MC-Color
    ...
    private static String formatHEX(String text) {
    ...
    private static String formatSpecial(char altColorChar, String input, boolean hexSupported) {
        String output = "";
        String format = "";
        String formatColor = "";
    ...
    private static String hexCompatibilityConverter(char altColorChar, String input_hex) {
        String output = "";
